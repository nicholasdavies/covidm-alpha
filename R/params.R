...
cm_translate_parameters = function(p)
{
    translate_time = function(t) {
        if (is.numeric(t)) {
            ...
            return (as.numeric(lubridate::ymd(t) - lubridate::ymd(p$date0)));
        }
    }
...
cm_check_parameters = function(parameters)
{
    ...
    req("date0",            "lubridate::is.Date(lubridate::ymd(date0))");
...
cm_base_pop_SEI3R = function(n_groups)
{
    list(
        name = "pop",
        group_names = as.character(1:n_groups),
...
cm_build_pop_SEI3R = function(dem_location, mat_location = "guess",
    ...
    v = NULL, ev = NULL, wn = NULL, wv = NULL, A = NULL, B = NULL, D = NULL, season_A = NULL, season_T = NULL, season_phi = NULL,
    ...
    seed_times = NULL, dist_seed_ages = NULL, observer = NULL, schedule = NULL)
{
    ...
    for (i in seq_along(dem_locations))
    {
        pop[[i]] = cm_build_pop_SEI3R(dem_locations[i], mat_locations[i],
            ...
            v = v, ev = ev, wn = wn, wv = wv, A = A, B = B, D = D, season_A = season_A, season_T = season_T, season_phi = season_phi,
